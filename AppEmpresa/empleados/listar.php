...
<table class="list">
    <thead><tr><th>CodEmple</th><th>Nombre</th><th>Apellido1</th><th>Apellido2</th><th>Departamento</th></tr></thead>
    <tbody>
    ...
    <tr>
        ...
        <td>
            ...
            <a href="borrar.php?id=<?= $r['CodEmple'] ?>"onclick="return confirm('Borrar empleado')">
                Borrar </a>
        </td>
    </tr>
    <?php endforeach; ?>
