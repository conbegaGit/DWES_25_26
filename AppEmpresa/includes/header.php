...
<header class="site-header">
    <div class="wrap">
        <h1 class="logo">
            <a href="/AppEmpresa/dashboard.php">Empresa</a>
        </h1>
        ...
        <nav class="main-nav">
            ...
            <?php if (isset($_SESSION['user']) && (int)$_SESSION['user']['Rol'] === 1): ?>
                <a href="/AppEmpresa/usuarios/listar.php">Usuarios</a>
            <?php endif; ?>

            <?php if (isset($_SESSION['user'])): ?>
                <a href="/AppEmpresa/logout.php">
                    Salir (<?= htmlspecialchars($_SESSION['user']['Nombre'], ENT_QUOTES, 'UTF-8') ?>)
                </a>
            <?php endif; ?>
        </nav>
    </div>
