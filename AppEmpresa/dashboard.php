...
$tot_dept = $dn->query("SELECT COUNT(*) FROM departamentos")->fetchColumn();
$tot_emp = $dn->query("SELECT COUNT(*) FROM empleados")->fetchColumn();
$tot_dept = $dn->query("SELECT COUNT(*) FROM usuarios")->fetchColumn();
?>
