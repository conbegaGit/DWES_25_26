...
SELECT 3, 'Ventas', NULL, 1004, 'Sevilla' FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM departamentos
WHERE CodDept=3);
INSERT INTO `departamentos` (`CodDept`, `Nombre`, `Jefe`, `Presupuesto`, `Ciudad`)
SELECT 4, 'Gerencia', NULL, 2000, 'Lugo' FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM departamentos
WHERE CodDept=4);
-- --------------------------------------------------------
-- Insertar empleados de manera segura
-- --------------------------------------------------------
INSERT INTO `empleados` (`CodEmple`, `Nombre`, `Apellido1`, `Apellido2`, `Departamento`)
SELECT 1, 'Ana', 'Fuentes', 'Teruel', 3 FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM empleados WHERE
CodEmple=1);
INSERT INTO `empleados` (`CodEmple`, `Nombre`, `Apellido1`, `Apellido2`, `Departamento`)
SELECT 2, 'Luis', 'Marea', 'Motos', 3 FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM empleados WHERE
CodEmple=2);
INSERT INTO `empleados` (`CodEmple`, `Nombre`, `Apellido1`, `Apellido2`, `Departamento`)
SELECT 4, 'Antonio', 'Hoz', 'Perales', 4 FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM empleados WHERE
CodEmple=4);
INSERT INTO `empleados` (`CodEmple`, `Nombre`, `Apellido1`, `Apellido2`, `Departamento`)
SELECT 5, 'Eloisa', 'Puertas', 'Torres', 4 FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM empleados WHERE
CodEmple=5);
-- --------------------------------------------------------
...
INSERT INTO `usuarios` (`Codigo`, `Nombre`, `Clave`, `Rol`)
SELECT 3, 'aco', '1234', 0 FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM usuarios WHERE Codigo=3);
INSERT INTO `usuarios` (`Codigo`, `Nombre`, `Clave`, `Rol`)
